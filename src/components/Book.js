...
const Book = ({ book, handleRemoveBook }) => {
  ...
  const cValue = Math.round((Math.floor(Math.random() * (100 - 1)) / 100) * 100);
    ...
    <div className="p-3">
      <div className="row data-card mt-5 mb-3 mx-auto bg-white">
        <div className="col-md-6 p-3">
          ...
          <h5 className="card-el-font font-weight-lighter text-primary">
            Book Id:
            {book.id}
          </h5>
          <p>
            ...
            <span className="text-muted font-weight-lighter h4 mr-3 ml-3">|</span>
            <span className="card-el-font data-card-link font-weight-lighter text-primary" role="button" tabIndex={0} onClick={() => handleRemoveBook(book.id)} onKeyDown={() => handleRemoveBook(book.id)}> Remove Book </span>
          </p>
        </div>
        <div className="row col-md-6">
          <div className="row col-md-6 p-4">
            ...
            <div className="col-md-4 mt-3">
              <h2 className="main-font font-weight-bold">
                {value}
                %
              </h2>
          ...
          <div className="col-md-6 p-4">
            ...
            <h6 className="card-el-font ml-5 mt-3 font-weight-light">
              Chapter&nbsp;
              {cValue}
            </h6>
            <button type="button" className="ml-5 mt-3 btn btn-primary font-weight-light card-el-font">UPDATE PROGRESS</button>
          </div>
        </div>
      </div>
